...
export const PROJECT_DETAILS: Record<string, ProjectDetail> = {
  ...
  famlymemo: {
    ...
    media: [
      {
        kind: "video",
        src: "https://digital-upstream.s3.eu-central-003.backblazeb2.com/famly%20memo/famly-memo-demo.mp4",
        alt: "FamlyMemo demo video",
        label: "Demo",
      },
      {
        kind: "image",
        src: "https://digital-upstream.s3.eu-central-003.backblazeb2.com/famly%20memo/hero.jpg",
        alt: "FamlyMemo hero screen",
        label: "Hero",
      },
      {
        kind: "image",
        src: "https://digital-upstream.s3.eu-central-003.backblazeb2.com/famly%20memo/landing-page%20-%20capture,%20store,%20share.jpg",
        alt: "FamlyMemo landing page: capture, store, share",
        label: "Landing page",
      },
      {
        kind: "image",
        src: "https://digital-upstream.s3.eu-central-003.backblazeb2.com/famly%20memo/quick%20story%20access%20and%20storage%20overview.jpg",
        alt: "FamlyMemo quick story access and storage overview screen",
        label: "Quick access + storage",
      },
      {
        kind: "image",
        src: "https://digital-upstream.s3.eu-central-003.backblazeb2.com/famly%20memo/powerfull%20editor.jpg",
        alt: "FamlyMemo editor screen",
        label: "Editor",
      },
      {
        kind: "image",
        src: "https://digital-upstream.s3.eu-central-003.backblazeb2.com/famly%20memo/lightbox%20and%20list%20views.jpg",
        alt: "FamlyMemo lightbox and list views screen",
        label: "Lightbox + lists",
      },
      {
        kind: "image",
        src: "https://digital-upstream.s3.eu-central-003.backblazeb2.com/famly%20memo/features.jpg",
        alt: "FamlyMemo features screen",
        label: "Features",
      },
    ],
    label: "CASE‑05",
  ...
  summaraize: {
    ...
    media: [
      {
        kind: "image",
        src: "https://digital-upstream.s3.eu-central-003.backblazeb2.com/summraize/hero.jpg",
        alt: "Summaraize hero screen",
        label: "Hero",
      },
      {
        kind: "image",
        src: "https://digital-upstream.s3.eu-central-003.backblazeb2.com/summraize/powerful%20solutions.jpg",
        alt: "Summaraize powerful solutions section",
        label: "Powerful solutions",
      },
      {
        kind: "image",
        src: "https://digital-upstream.s3.eu-central-003.backblazeb2.com/summraize/who%20uses%20summraize.jpg",
        alt: "Summaraize who uses Summaraize section",
        label: "Who uses Summaraize",
      },
      {
        kind: "image",
        src: "https://digital-upstream.s3.eu-central-003.backblazeb2.com/summraize/who%20uses%20summraize%20part%202.jpg",
        alt: "Summaraize who uses Summaraize section (part 2)",
        label: "Who uses Summaraize (2)",
      },
      {
        kind: "image",
        src: "https://digital-upstream.s3.eu-central-003.backblazeb2.com/summraize/trusted%20by%20users.jpg",
        alt: "Summaraize trusted by users section",
        label: "Trusted by users",
      },
      {
        kind: "image",
        src: "https://digital-upstream.s3.eu-central-003.backblazeb2.com/summraize/why%20chose%20summraize.jpg",
        alt: "Summaraize why choose Summaraize section",
        label: "Why choose Summaraize",
      },
      {
        kind: "image",
        src: "https://digital-upstream.s3.eu-central-003.backblazeb2.com/summraize/pricing.jpg",
        alt: "Summaraize pricing screen",
        label: "Pricing",
      },
      {
        kind: "image",
        src: "https://digital-upstream.s3.eu-central-003.backblazeb2.com/summraize/credit+usage.jpg",
        alt: "Summaraize credit usage screen",
        label: "Credit usage",
      },
    ],
    label: "CASE‑07",
