        ...
        <div className="max-w-6xl mx-auto w-full text-left">
          ...
          <Reveal delay={100}>
            <Parallax strength={0.08} maxTranslate={24}>
              <ul className="mt-12 sm:mt-16 lg:mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 lg:gap-16 md:divide-x divide-foreground/10 list-none m-0 p-0">
                <li className="pr-0 md:pr-8 text-left">
                ...
                <li className="md:px-8 text-center md:text-left">
                ...
                <li className="md:pl-8 text-right md:text-left">
