...
export default function HeroSection() {
  return (
    <section className="min-h-screen flex items-center" aria-labelledby="hero-title">
      <div className="grid grid-cols-1 md:grid-cols-2 items-start w-full gap-y-12 md:gap-x-8">
        ...
        <div className="flex items-start justify-start text-left relative py-20 sm:py-24 md:py-32 px-4 sm:px-6 md:px-8">
          <Reveal delay={100}>
            <div>
              <DGLabel Icon={Diamond} label="DU‑01" className="text-foreground/70" />
              {/* Accessible page heading; visually hidden to avoid visual changes */}
              <h1 id="hero-title" className="sr-only">Designing standout brands and seamless interfaces</h1>
              <p className="text-4xl sm:text-5xl tracking-tight" aria-describedby="hero-title">
